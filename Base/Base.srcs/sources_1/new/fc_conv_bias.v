...
//     output reg done, mem_req
    ...
    FSMController fsm (isFC, isConv, clk, start, max_x, max_y, size, cols, pxl_ptr, ker_ptr, bias_ptr, weight_ptr, out_ptr, max_ch, reset, fc_write, r3write, conv_compute, mem_ptr, banksel, colsel, regsel, done, mem_wr);
