...
mux2_32bit Mux1(ID_PC_Input_PlusFour, JMP_PC, JMP_PCMUX, PC_Input);
...
registerfile RegisterFile(S1Reg, S2Reg, V_WB_LDREG, WB_DR, WB_DATA, clock, EX_SR1_Input, EX_SR2_Input, reset);
