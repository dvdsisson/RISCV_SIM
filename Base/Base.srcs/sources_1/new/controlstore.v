...
mux8_32bit Mux4(BR0, BR1, BR2, BR3, BR4, BR5, BR6, BR7, BRSelect, BROutput);
mux2_32bit Mux5(AC0, AC1, ACSelect, ACOutput);
mux2_32bit Mux6(JMP0, JMP1, JMPSelect, JMPOutput);

and(four, IR[5], IR[25]);
or(five, IR[2], IR[3], IR[4]);
mux2_32bit Mux7(LSOutput, BROutput, IR[6], six);
