        ...
        case (state)
            ...
            5'b00100: begin
                ...
                if (ready) begin
                    regsel <= regsel+1;
                    fc_write <= 1;
                    if (regsel >= 4 || (regsel+x) >= max) begin //increment y
                        state = 5'b00101;
            ...
            5'b00110: begin
                ...
                if (ready) begin
                    ...
                    if ((regsel+x) >= max) begin
                        ...
                        mem_req <= 0;
                        state <= 5'b00000;
                    end else if (regsel >= 4) begin //increment y
                        state = 5'b00100;
                        regsel <= 0; 
            ...
            5'b01101: begin
                mem_ptr <= weight_ptr + linesize * (y + regsel) + x;
                banksel <= 1;
                if (ready) begin
                    regsel <= regsel+1;
                    fc_write <= 1;
            ...
            5'b10011: begin
                ch <= 0;
                conv_compute <= 0;
                mem_ptr <= out_ptr + linesize * (y + colsel) + x + regsel;
